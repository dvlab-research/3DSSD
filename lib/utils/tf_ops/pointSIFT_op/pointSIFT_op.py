...
def pointSIFT_judge_direction(xyz):
    """ Judge Direction inside each group 
    :param: xyz: [batch_size, npoint, sample_num, 3]
    :return: direction: [batch_size, npoint, sample_num]
    """
    pass


def pointSIFT_select_modified(xyz1, xyz2):
    """ Modified PointSift module
    :param xyz1: (b, n, 3) float
    :param xyz2: (b, m, 3) float
    :return: (b, n, 8) int
    """
    idx = pointSIFT_module.cube_select_modified(xyz1, xyz2)
    return idx

ops.NoGradient('CubeSelectModified')
