...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>83.62</td>
            <td>80.67</td>
            <td><a href="https://drive.google.com/drive/folders/1iWTA3fmKHg5L1g_c4cusMHMOEJctG0fG?usp=sharing"> model </a></td>
        </tr>
        <tr>
            <td>PointRCNN</td>
            <td>91.31</td>
...
(2) Choose the target configure file in configs directory (i.e., configs/kitti/3dssd/3dssd.yaml). Then run
